      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="rounded-3xl overflow-hidden shadow-xl min-h-[450px] lg:min-h-full relative bg-zinc-200">
              <iframe
                title="DBTECHX Location"
                src="https://maps.google.com/maps?q=Hope%20Hospital%20Chowk%20Purnea%20Bihar&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
